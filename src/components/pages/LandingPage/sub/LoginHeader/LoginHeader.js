...
class LoginHeader extends React.Component {
  ...
  sendPasswordResetEmail = e => {
    ...
    Axios.post(process.env.REACT_APP_NODE_URL + '/reset-password', data, {withCredentials: true})
      .then(_ => {
        this.handleClose();
      })
      .catch(err => {
  ...
  login = e => {
    ...
    Axios.post(process.env.REACT_APP_NODE_URL + '/login', loginData, {withCredentials: true})
      .then(res => {
        consoleLog(res);
