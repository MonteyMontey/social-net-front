  ...
  return (
    <Navbar bg="dark" variant="dark">
      ...
      <Nav className="ml-auto mr-sm-5">
        <Nav.Link href="#FriendRequests"><i class="fas fa-users fa-lg"></i></Nav.Link>
        <Nav.Link href="#Messages"><i class="fas fa-comments fa-lg"></i></Nav.Link>
        <Nav.Link href="#Alerts"><i class="fas fa-bell fa-lg"></i></Nav.Link>
